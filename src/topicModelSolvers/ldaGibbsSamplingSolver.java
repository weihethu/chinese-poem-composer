...
public class ldaGibbsSamplingSolver extends solverInterface {
	 ...
	 * @param detailed whether output detailed information
	 */
	 ...
	 */
	private void init() {
		document_topic_cnt = new int[nDocument][nTopic];//topic distribution given document
		...
		topic_assigned = new int[nDocument][];//which topic each term is assigned to
