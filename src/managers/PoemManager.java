...
public class PoemManager {
    ...
    /**
     * preprocess raw data which I download from internet
     * the following code only applies for quantangshi of a specific format 
     * since I already provide a preprocessed file, the method should not be called
     * I add no comments because you don't need to read the code
     * 
     * @param shiFile the raw data file
     * @param preProcessedFile the preprocess file
     */
     ...
     * @param preprocessedFile preprocessed file
     */
	...
	try {
		...
		if (line.isEmpty())
		    ...
		    // this line contains the pattern check result, don't need to load this into memory
		} else {
